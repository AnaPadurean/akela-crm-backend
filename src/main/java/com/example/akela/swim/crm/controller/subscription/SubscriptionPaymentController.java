...
public class SubscriptionPaymentController {
    ...
    public ResponseEntity<PaymentDTO> createPayment(
        ...
        SubscriptionPaymentEntity saved =
                paymentService.createPayment(subscriptionId, dto);
        ...
        res.setChildFullName(
                sub.getChild().getChildLastName() + " " +
                        sub.getChild().getChildFirstName()
        );

        res.setPlanName(
                sub.getPlan().getSubscriptionType().getName() +
                        " (" + sub.getPlan().getSessions() + " ședințe)"
        );
    ...
    /**
     * 🔹 Listă încasări (pentru pagina „Încasări”)
     * GET /api/payments
     * Optional: filtre de dată
     */
    @GetMapping("/payments")
    public ResponseEntity<List<PaymentDTO>> getPayments(
        ...
        List<PaymentDTO> list = paymentService.getAll(from, to)
                .stream()
                .map(p -> {
